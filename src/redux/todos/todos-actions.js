...
export const deleteTodoError = createAction(
  'todos/deleteTodoError'
);

export const toggleCompletedRequest =
  createAction('todos/toggleCompletedRequest');
export const toggleCompletedSuccess =
  createAction('todos/toggleCompletedSuccess');
